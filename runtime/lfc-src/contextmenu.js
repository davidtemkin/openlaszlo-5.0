...
static var tagname = "lzcontextmenuseparator";static var attributes = new LzInheritedHash(LzView.attributes);function $ii6lnt1 ($a) {
#file
...
static var tagname = "lzcontextmenutext";static var attributes = new LzInheritedHash(LzText.attributes);function $ii6lnt3 ($a) {
#file
...
#file contextmenu.lzx
#line 134
dynamic class $lzc$class_ii6lntc extends LzView {
static var displayName = "<anonymous extends='view'>";static var attributes = new LzInheritedHash(LzView.attributes);function $ii6lnt7 ($a) {
#file
...
#file
var $classrootdepth;function $lzc$class_ii6lntc (parent_$a:LzNode? = null, attrs_$b:Object? = null, children_$c:Array? = null, async_$d:Boolean = false) {
super(parent_$a, attrs_$b, children_$c, async_$d)
}
...
static var tagname = "lzcontextmenu";static var children = [{attrs: {$classrootdepth: 1, $delegates: ["oninit", "$ii6lntb", null, "onwidth", "__doredraw", null, "onheight", "__doredraw", null, "oncontext", "__doredraw", null, "onvisible", "__doredraw", null], height: new LzAlwaysExpr("height", "size", "$ii6lnt9", "$ii6lnta", $debug ? "height='${...}'" : null), name: "background", width: new LzAlwaysExpr("width", "size", "$ii6lnt7", "$ii6lnt8", $debug ? "width='${...}'" : null)}, "class": $lzc$class_ii6lntc}, {attrs: {$classrootdepth: 1, name: "container", x: 3, y: 3}, "class": LzView}, {attrs: "container", "class": $lzc$class_userClassPlacement}];static var attributes = new LzInheritedHash(LzView.attributes);var inset;var __drawnitems;var __overnow;function $ii6lnt6 ($a) {
#file
