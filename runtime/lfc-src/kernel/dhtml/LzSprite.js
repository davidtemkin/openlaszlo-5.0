...
var LzSprite = function(owner, isroot) {
    ...
    if (isroot) {
        ...
        if (quirks.fix_clickable) {
            ...
            LzSprite.__setClickable(true, appcontainer);
        }
...
LzSprite.__updateQuirks = function () {
    ...
    if (window['lz'] && lz.embed && lz.embed.browser) {
        ...
        if (browser.isIE) {
            ...
            // Webkit matches swf8 best with this
            defaultStyles.lzswfinputtext.paddingTop = '0px';
            defaultStyles.lzswfinputtext.paddingBottom = '2px';
...
LzSprite.__clickDispatcher = function(e) {
    ...
    if (LzSprite.prototype.capabilities.touchevents) {
        ...
        if (eventname === 'ontouchstart') {
            ...
            // Send artificial mouseover event
            ...
            if (e.touches.length != 0) {
                //Debug.warn('more than 0 fingers', e.owner.owner);
                return true;
            }
            eventname = 'onmouseup';
            ...
            var callback = lz.BrowserUtils.getcallbackfunc(owner, '__mouseEvent', ['onclick']);
            setTimeout(callback, 0);
        } else {
    ...
    if (owner.isroot === true) {
        ...
        // Send global event
        LzMouseKernel.__sendEvent(eventname, null);
    ...
    if (eventname == 'onmousedown') {
        ...
        if (LzMouseKernel.__lastMouseDown !== owner) {
            return;
        } else {
